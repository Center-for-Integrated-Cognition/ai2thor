...
class Build(object):
    ...
    def url(self):
        if self.cic_fork:
            return "https://github.com/Center-for-Integrated-Cognition/ai2thor/releases/download/5.0.3-Windows/ai2thor_windows.zip"
    ...
    def log_exists(self):
        return requests.head(self.log_url, auth=self.auth(), allow_redirects=True).status_code == 200
